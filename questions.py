...
QUESTIONS = [
    ...
    },
    {
        ...
        "question": "A company reports the following data. Calculate the DSO (days sales outstanding) ratio.\n\nSales: $35,000 | Accounts Receivable: $750 | COGS: $20,000 | Inventory: $3,000 | Accounts Payable: $1,500",
        "options": [
            "7.83",
            "8.4",
            "55.1",
        ...
        "correct": 0,
        "explanation": "**DSO = Accounts Receivable ÷ (Annual Sales ÷ 365)**\n\n• DSO = $750 ÷ ($35,000 ÷ 365)\n• DSO = $750 ÷ $95.89 = **7.83 days**\n\nDSO measures the average number of days it takes to collect payment after a sale. A lower DSO means faster collection."
    },
    {
        "id": 32,
        "chapter": 4,
        "topic": "Inventory Turnover",
        "question": "Using the same company data, calculate the inventory turnover ratio.\n\nSales: $35,000 | Accounts Receivable: $750 | COGS: $20,000 | Inventory: $3,000 | Accounts Payable: $1,500",
        "options": [
            "27.23",
            "13.3",
            "55.43",
        ...
        "correct": 3,
        "explanation": "**Inventory Turnover = Sales ÷ Inventory**\n\n• Inventory Turnover = $35,000 ÷ $3,000 = **11.67**\n\nThis ratio measures how many times inventory is sold and replaced over a period. A turnover of 11.67 means the company sells through its entire inventory roughly 11.67 times per year. Higher turnover generally indicates efficient inventory management."
    },
    {
        "id": 33,
        "chapter": 4,
        "topic": "Return on Equity",
        "question": "MaxCorp reports the following financial data. Calculate the return on equity (ROE).\n\nNet Sales: $5,000 | Total Assets: $3,000 | Depreciation: $260 | Net Income: $600 | Long-term Debt: $2,000 | Equity: $2,160",
        "options": [
            "20.4%",
            "17.8%",
            "22.4%",
        ...
        "correct": 3,
        "explanation": "**ROE = Net Income ÷ Total Common Equity**\n\n• ROE = $600 ÷ $2,160 = **27.78% ≈ 27.8%**\n\nROE measures the return generated on shareholders' investment. MaxCorp's ROE of 27.8% indicates strong profitability — for every dollar shareholders have invested, the company generates about 28 cents in profit."
    },
    ...
    },
    {
        ...
        "question": "The British Pub Corporation — What was British Pub's return on total assets for 199X?\n\nIncome Statement: Net sales $1,025 | COGS $682 | EBITDA $343 | Depreciation $31 | Operating exp $103 | Admin exp $127 | EBIT $82 | Interest $27 | EBT $55 | Taxes $17 | Net income $38\n\nBalance Sheet: Cash $61 | AR $286 | Inventory $354 | Current assets $701 | Net fixed assets $802 | Total assets $1,503\nNotes payable $223 | AP $152 | Accruals $32 | Current liab $407 | LT debt $306 | Common stock $102 | RE $688 | Total L&E $1,503\n\n68,000 shares outstanding. (All figures in thousands)",
        "options": [
            "2.53%",
            "3.47%",
            "4.81%",
    ...
    },
    {
        ...
        "chapter": 4,
        "topic": "Return on Equity",
        "question": "The British Pub Corporation — What was British Pub's return on owners' equity in 199X?\n\nIncome Statement: Net sales $1,025 | COGS $682 | EBITDA $343 | Depreciation $31 | Operating exp $103 | Admin exp $127 | EBIT $82 | Interest $27 | EBT $55 | Taxes $17 | Net income $38\n\nBalance Sheet: Cash $61 | AR $286 | Inventory $354 | Current assets $701 | Net fixed assets $802 | Total assets $1,503\nNotes payable $223 | AP $152 | Accruals $32 | Current liab $407 | LT debt $306 | Common stock $102 | RE $688 | Total L&E $1,503\n\n68,000 shares outstanding. (All figures in thousands)",
        "options": [
            "4.81%",
            "5.93%",
            "6.75%",
    ...
    },
    {
        ...
        "chapter": 4,
        "topic": "Book Value Per Share",
        "question": "The British Pub Corporation — What was British Pub's book value per share at year-end 199X?\n\nIncome Statement: Net sales $1,025 | COGS $682 | EBITDA $343 | Depreciation $31 | Operating exp $103 | Admin exp $127 | EBIT $82 | Interest $27 | EBT $55 | Taxes $17 | Net income $38\n\nBalance Sheet: Cash $61 | AR $286 | Inventory $354 | Current assets $701 | Net fixed assets $802 | Total assets $1,503\nNotes payable $223 | AP $152 | Accruals $32 | Current liab $407 | LT debt $306 | Common stock $102 | RE $688 | Total L&E $1,503\n\n68,000 shares outstanding. (All figures in thousands)",
        "options": [
            "$7.74",
            "$8.29",
            "$11.62",
    ...
    },
    {
        ...
        "chapter": 3,
        "topic": "Net Operating Working Capital",
        "question": "Sebring Corporation — What is Sebring's net operating working capital for 2013?\n\nIncome (2013): Sales $3,600M | Op costs $3,060M | EBITDA $540M | D&A $90M | EBIT $450M | Interest $65M | EBT $385M | Taxes(40%) $154M | NI $231M\n\nBalance Sheet (2013): Cash $36M | AR $540M | Inventory $540M | Current assets $1,116M | Gross fixed assets $990M | Net fixed assets $900M | Total assets $2,016M\nAP $324M | Notes payable $201M | Accruals $216M | Total CL $741M | LT bonds $450M | Common stock $150M | RE $675M\n\nBalance Sheet (2012): Current assets $1,080M | Net fixed assets $825M | Total assets $1,830M\nAP $270M | Notes payable $155M | Accruals $180M | Total CL $605M | LT bonds $450M\n\nAfter-tax cost of capital: 10%",
        "options": [
            "$540,000,000",
            "$576,000,000",
            "$750,000,000",
    ...
    },
    {
        ...
        "chapter": 3,
        "topic": "Free Cash Flow",
        "question": "Sebring Corporation — What is Sebring's free cash flow for 2013?\n\nIncome (2013): Sales $3,600M | Op costs $3,060M | EBITDA $540M | D&A $90M | EBIT $450M | Interest $65M | EBT $385M | Taxes(40%) $154M | NI $231M\n\nBalance Sheet (2013): Cash $36M | AR $540M | Inventory $540M | Current assets $1,116M | Gross fixed assets $990M | Net fixed assets $900M | Total assets $2,016M\nAP $324M | Notes payable $201M | Accruals $216M | Total CL $741M | LT bonds $450M | Common stock $150M | RE $675M\n\nBalance Sheet (2012): Cash $30M | AR $450M | Inventory $600M | Current assets $1,080M | Gross fixed assets $825M | Net fixed assets $825M | Total assets $1,830M\nAP $270M | Notes payable $155M | Accruals $180M | Total CL $605M | LT bonds $450M | Common stock $150M | RE $625M\n\nAfter-tax cost of capital: 10%",
        "options": [
            "$85,000,000",
            "$146,000,000",
            "$249,000,000",
        ...
        "correct": 2,
        "explanation": "**FCF = NOPAT − Net Investment in Operating Capital**\n\n• NOPAT = EBIT × (1−T) = $450M × 0.60 = $270M\n• NOWC 2013 = $1,116M − ($741M − $201M) = $576M\n• NOWC 2012 = $1,080M − ($605M − $155M) = $630M\n• ΔNOWC = $576M − $630M = −$54M\n• ΔNet Fixed Assets = $900M − $825M = $75M\n• Net Investment in Op Capital = −$54M + $75M = $21M\n• FCF = $270M − $21M = **$249M**\n\nFCF is the cash available to distribute to all investors."
    },
    {
        "id": 41,
        "chapter": 3,
