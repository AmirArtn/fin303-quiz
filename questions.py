...
QUESTIONS = [
    ...
    },
    {
        ...
        "question": "A company reports the following data. Calculate the inventory turnover ratio.\n\n• Sales: $35,000\n• Accounts Receivable: $750\n• COGS: $20,000\n• Inventory: $3,000\n• Accounts Payable: $1,500",
        "options": [
            "27.23",
            "13.3",
            "55.43",
    ...
    # ──── British Pub Corporation Questions (34-37) ────
    {
        ...
        "chapter": 4,
        "topic": "Current Ratio",
        "question": "The British Pub Corporation — What was British Pub's current ratio for 199X? (All figures in thousands)\n\nINCOME STATEMENT:\n• Net sales: $1,025\n• COGS: $682\n• EBITDA: $343\n• Depreciation: $31\n• Operating exp: $103\n• Admin exp: $127\n• EBIT: $82\n• Interest: $27\n• EBT: $55\n• Taxes: $17\n• Net income: $38\n\nBALANCE SHEET:\n• Cash: $61\n• AR: $286\n• Inventory: $354\n• Current assets: $701\n• Net fixed assets: $802\n• Total assets: $1,503\n• Notes payable: $223\n• AP: $152\n• Accruals: $32\n• Current liab: $407\n• LT debt: $306\n• Common stock: $102\n• RE: $688\n\n68,000 shares outstanding.",
        "options": [
            "0.55",
            "1.73",
            "1.02",
    ...
    },
    {
        ...
        "question": "The British Pub Corporation — What was British Pub's return on total assets for 199X? (All figures in thousands)\n\nINCOME STATEMENT:\n• Net sales: $1,025\n• COGS: $682\n• EBITDA: $343\n• Depreciation: $31\n• Operating exp: $103\n• Admin exp: $127\n• EBIT: $82\n• Interest: $27\n• EBT: $55\n• Taxes: $17\n• Net income: $38\n\nBALANCE SHEET:\n• Cash: $61\n• AR: $286\n• Inventory: $354\n• Current assets: $701\n• Net fixed assets: $802\n• Total assets: $1,503\n• Notes payable: $223\n• AP: $152\n• Accruals: $32\n• Current liab: $407\n• LT debt: $306\n• Common stock: $102\n• RE: $688\n\n68,000 shares outstanding.",
        "options": [
            "2.53%",
            "3.47%",
            "4.81%",
    ...
    },
    {
        ...
        "chapter": 4,
        "topic": "Return on Equity",
        "question": "The British Pub Corporation — What was British Pub's return on owners' equity in 199X? (All figures in thousands)\n\nINCOME STATEMENT:\n• Net sales: $1,025\n• COGS: $682\n• EBITDA: $343\n• Depreciation: $31\n• Operating exp: $103\n• Admin exp: $127\n• EBIT: $82\n• Interest: $27\n• EBT: $55\n• Taxes: $17\n• Net income: $38\n\nBALANCE SHEET:\n• Cash: $61\n• AR: $286\n• Inventory: $354\n• Current assets: $701\n• Net fixed assets: $802\n• Total assets: $1,503\n• Notes payable: $223\n• AP: $152\n• Accruals: $32\n• Current liab: $407\n• LT debt: $306\n• Common stock: $102\n• RE: $688\n\n68,000 shares outstanding.",
        "options": [
            "4.81%",
            "5.93%",
            "6.75%",
    ...
    },
    {
        ...
        "chapter": 4,
        "topic": "Book Value Per Share",
        "question": "The British Pub Corporation — What was British Pub's book value per share at year-end 199X? (All figures in thousands)\n\nINCOME STATEMENT:\n• Net sales: $1,025\n• COGS: $682\n• EBITDA: $343\n• Depreciation: $31\n• Operating exp: $103\n• Admin exp: $127\n• EBIT: $82\n• Interest: $27\n• EBT: $55\n• Taxes: $17\n• Net income: $38\n\nBALANCE SHEET:\n• Cash: $61\n• AR: $286\n• Inventory: $354\n• Current assets: $701\n• Net fixed assets: $802\n• Total assets: $1,503\n• Notes payable: $223\n• AP: $152\n• Accruals: $32\n• Current liab: $407\n• LT debt: $306\n• Common stock: $102\n• RE: $688\n\n68,000 shares outstanding.",
        "options": [
            "$7.74",
            "$8.29",
            "$11.62",
    ...
    # ──── Sebring Corporation Questions (38-40) ────
    {
        ...
        "chapter": 3,
        "topic": "NOPAT",
        "question": "Sebring Corporation — What is Sebring's net operating profit after taxes (NOPAT) for 2013? (Millions of dollars)\n\nINCOME STATEMENT (2013):\n• Sales: $3,600\n• Operating costs: $3,060\n• EBITDA: $540\n• D&A: $90\n• EBIT: $450\n• Interest: $65\n• EBT: $385\n• Taxes (40%): $154\n• Net income: $231\n\nBALANCE SHEET (2013):\n• Current assets: $1,116\n• Net fixed assets: $900\n• Total assets: $2,016\n• AP: $324\n• Notes payable: $201\n• Accruals: $216\n• Total CL: $741\n• LT bonds: $450\n• Common stock: $150\n• RE: $675\n\nAfter-tax cost of capital: 10%",
        "options": [
            "$150,000,000",
            "$225,000,000",
            "$270,000,000",
    ...
    },
    {
        ...
        "chapter": 3,
        "topic": "Net Operating Working Capital",
        "question": "Sebring Corporation — What is Sebring's net operating working capital for 2013? (Millions of dollars)\n\nINCOME STATEMENT (2013):\n• Sales: $3,600\n• Operating costs: $3,060\n• EBITDA: $540\n• D&A: $90\n• EBIT: $450\n• Interest: $65\n• EBT: $385\n• Taxes (40%): $154\n• Net income: $231\n\nBALANCE SHEET (2013):\n• Cash: $36\n• AR: $540\n• Inventory: $540\n• Current assets: $1,116\n• Gross fixed assets: $990\n• Net fixed assets: $900\n• Total assets: $2,016\n• AP: $324\n• Notes payable: $201\n• Accruals: $216\n• Total CL: $741\n• LT bonds: $450\n• Common stock: $150\n• RE: $675\n\nBALANCE SHEET (2012):\n• Current assets: $1,080\n• Net fixed assets: $825\n• Total assets: $1,830\n• AP: $270\n• Notes payable: $155\n• Accruals: $180\n• Total CL: $605\n• LT bonds: $450\n\nAfter-tax cost of capital: 10%",
        "options": [
            "$540,000,000",
            "$576,000,000",
            "$750,000,000",
    ...
    },
    {
        ...
        "chapter": 3,
        "topic": "Free Cash Flow",
        "question": "Sebring Corporation — What is Sebring's free cash flow for 2013? (Millions of dollars)\n\nINCOME STATEMENT (2013):\n• Sales: $3,600\n• Operating costs: $3,060\n• EBITDA: $540\n• D&A: $90\n• EBIT: $450\n• Interest: $65\n• EBT: $385\n• Taxes (40%): $154\n• Net income: $231\n\nBALANCE SHEET (2013):\n• Cash: $36\n• AR: $540\n• Inventory: $540\n• Current assets: $1,116\n• Gross fixed assets: $990\n• Net fixed assets: $900\n• Total assets: $2,016\n• AP: $324\n• Notes payable: $201\n• Accruals: $216\n• Total CL: $741\n• LT bonds: $450\n• Common stock: $150\n• RE: $675\n\nBALANCE SHEET (2012):\n• Cash: $30\n• AR: $450\n• Inventory: $600\n• Current assets: $1,080\n• Gross fixed assets: $825\n• Net fixed assets: $825\n• Total assets: $1,830\n• AP: $270\n• Notes payable: $155\n• Accruals: $180\n• Total CL: $605\n• LT bonds: $450\n• Common stock: $150\n• RE: $625\n\nAfter-tax cost of capital: 10%",
        "options": [
            "$85,000,000",
            "$146,000,000",
            "$249,000,000",
